...
class Decoder(tf.keras.Model):
    def __init__(self,embedding_matrix,embedding_matrix2):
        ...
        self.lstm =tf.keras.layers.CuDNNLSTM(
            ...
            return_sequences=True,
            return_state=False,
            #kernel_initializer=tf.keras.initializers.RandomUniform(minval=-tf.rsqrt(6 / (200 + 50)), maxval=tf.rsqrt(6 / (200 + 50))),
        ...
        self.bi_lstm = tf.keras.layers.Bidirectional(tf.keras.layers.CuDNNLSTM(
            name="bi_lstm",
            units=LSTM_UNITS,
            return_sequences=True,
            return_state=False,
